...
1. Read `.cursor/CONTEXT.md`, then the relevant files in `docs/mvp/` (and `docs/stories/` when present).
2. Classify the work:
...
5. If docs are still stubs only, use **grill-me** before inventing behavior. If app code exists, use **grill-with-docs**.
